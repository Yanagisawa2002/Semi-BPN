...
RUN_NAME="${RUN_NAME:-pairwise_k50_fallback_indication_d${HIDDEN_DIM}_l${HIDDEN_LAYERS}_b${TRAIN_BATCH_SIZE}_e${TRAIN_EPOCHS}}"
OUTPUT_DIR="${OUTPUT_DIR:-$PWD/results/biopathnet_linux_k50_fallback_indication_pairwise_${RUN_NAME}}"
...
CONFIG_RUNTIME="$PWD/results/runtime_configs/biopathnet_linux_k50_fallback_indication_pairwise_${RUN_NAME}.yaml"
python -m mechrep.training.prepare_original_config \
  --config "$PWD/configs/biopathnet_linux_k50_fallback_indication_pairwise.yaml" \
