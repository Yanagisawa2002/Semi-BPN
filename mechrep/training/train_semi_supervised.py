...
def run_semi_template_training(config: dict, *, create_toy_data: bool = False) -> dict:
    ...
    for split in ("train", "valid", "test"):
        ...
        if split == "train" and selected_record:
            ...
            metrics[split]["final_loss_pseudo"] = selected_record["loss_pseudo"]
            metrics[split]["final_loss_total"] = selected_record["loss_total"]
            metrics[split]["train_num_gold_template_examples"] = selected_record["num_gold_template_examples"]
            metrics[split]["train_num_pseudo_template_examples"] = selected_record["num_pseudo_template_examples"]
